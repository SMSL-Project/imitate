...
class MoveGrassFromRedLandToBoat(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "pick up the grass from the red land and place it on the boat"
        self.task_completed_desc = "done moving the grass from the red land to the boat."
