...
class MoveSheepFromBoatToGreenLand(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "pick up the sheep from the boat and place it on the green land"
        self.task_completed_desc = "done moving the sheep from the boat to the green land."
