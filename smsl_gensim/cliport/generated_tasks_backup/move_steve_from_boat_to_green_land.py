...
class MoveSteveFromBoatToGreenLand(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "pick up Steve from the boat and place him on the green land"
        self.task_completed_desc = "done moving Steve from the boat to the green land."
