...
class MoveCircleChessToBlockUppercaseD(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "move the red circle chess piece to the block labeled 'D'"
        self.task_completed_desc = "done moving the red circle chess piece to the block labeled 'D'."
