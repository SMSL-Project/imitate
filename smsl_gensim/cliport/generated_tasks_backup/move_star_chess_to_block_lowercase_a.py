...
class MoveStarChessToBlockLowercaseA(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "pick up the star chess piece and place it on the lowercase 'a' block"
        self.task_completed_desc = "done moving the star chess piece to the lowercase 'a' block."
