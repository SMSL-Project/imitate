...
class MoveSheepFromGreenLandToBoat(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "pick up the sheep figure from the green land and place it onto the boat"
        self.task_completed_desc = "done moving the sheep from the green land to the boat."
