...
class MoveCircleChessToBlockLowercaseA(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "pick up the circle chess piece and place it on the square labeled 'a'"
        self.task_completed_desc = "done moving the circle chess piece to the square labeled 'a'."
