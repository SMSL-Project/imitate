...
class MoveCircleChessToBlock1(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "move the red circle chess piece to the block labeled '1' on the chessboard"
        self.task_completed_desc = "done moving the red circle chess piece to block '1'."
    ...
    def reset(self, env):
        ...
        trans = (0.150, -0.100, 0.040)  # translation for block '1'
