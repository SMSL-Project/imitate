...
class MoveGrassFromBoatToRedLand(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "pick up the grass object from the boat and place it onto the red land"
        self.task_completed_desc = "done moving the grass from the boat to the red land."
