...
class MoveGrassFromGreenLandToBoat(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "move the grass block from the green land to the boat"
        self.task_completed_desc = "done moving the grass block from the green land to the boat."
