...
class MoveStarChessToBlockUppercaseB(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the star chess piece to the board position labeled with the uppercase letter B."
        self.task_completed_desc = "done moving star chess piece to B."
