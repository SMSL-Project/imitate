...
class MoveCircleChessToBlockUppercaseC(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the circle chess piece to the block labeled with the uppercase letter C on the chessboard."
        self.task_completed_desc = "done moving circle chess piece to block C."
    ...
    def reset(self, env):
        ...
        # Calculate zone and target positions
        zone_position = utils.apply(base_pose, (0.050, 0.100, 0.040))
