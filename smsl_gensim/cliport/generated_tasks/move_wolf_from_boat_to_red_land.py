...
class MoveWolfFromBoatToRedLand(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the wolf from the boat to the red land."
        self.task_completed_desc = "done moving the wolf to the red land."
    ...
    def reset(self, env):
        ...
        slot_x, slot_y = slots[np.random.randint(0, len(slots))]
