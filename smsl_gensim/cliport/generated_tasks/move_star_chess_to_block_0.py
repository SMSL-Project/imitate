...
class MoveStarChessToBlock0(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the star chess piece to the designated block 0 position on the chessboard."
        self.task_completed_desc = "done moving star chess piece to block 0."
