...
class MoveCircleChessToBlockLowercaseC(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the circle chess piece to the board slot labeled with the lowercase letter 'c'."
        self.task_completed_desc = "done moving circle chess piece to block lowercase c."
    ...
    def reset(self, env):
        ...
        zone_position = utils.apply(base_pose, (0.050, 0.000, 0.040))
