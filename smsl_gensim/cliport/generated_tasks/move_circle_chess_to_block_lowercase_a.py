...
class MoveCircleChessToBlockLowercaseA(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the circle chess piece to the board position labeled with the lowercase letter 'a'."
        self.task_completed_desc = "done moving circle chess piece to lowercase 'a'."
