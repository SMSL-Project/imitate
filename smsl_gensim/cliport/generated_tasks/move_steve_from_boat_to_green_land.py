...
class MoveSteveFromBoatToGreenLand(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the character Steve from the boat to the green land."
        self.task_completed_desc = "Steve has been successfully moved to the green land."
