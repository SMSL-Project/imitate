...
class MoveStarChessToBlockLowercaseA(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the star chess piece to the board slot labeled with the lowercase letter 'a'."
        self.task_completed_desc = "done moving star chess piece to block lowercase a."
