...
class MoveStarChessToBlock1(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the star chess piece to the designated block 1 position on the chessboard."
        self.task_completed_desc = "done moving the star chess piece to block 1."
