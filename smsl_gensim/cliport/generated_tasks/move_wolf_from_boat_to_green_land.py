...
class MoveWolfFromBoatToGreenLand(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the wolf from the boat to the green land."
        self.task_completed_desc = "done moving the wolf to the green land."
        self.additional_reset()

    def reset(self, env):
        super().reset(env)
        obj_id = env.asset_ids_dict["rigid"]["minecraft/wolf.urdf"]
