...
class MoveCircleChessToBlockUppercaseB(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the circle chess piece to the board slot labeled with the uppercase letter B."
        self.task_completed_desc = "done moving circle chess piece to B."
