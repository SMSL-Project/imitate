...
class MoveCircleChessToBlockUppercaseA(Task):
    def __init__(self):
        super().__init__()
        self.max_steps = 1
        self.lang_template = "Move the circle chess piece to the block labeled with an uppercase 'A' on the chessboard."
        self.task_completed_desc = "done moving circle chess piece to block labeled 'A'."
