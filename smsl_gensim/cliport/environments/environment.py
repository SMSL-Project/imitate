...
class Environment(gym.Env):
    ...
    def __init__(self,
        ...
        self.asset_poses_dict = {}
        self.asset_ids_dict = {'fixed': {}, 'rigid': {}, 'deformable': {}}
    ...
    def move_object(self, obj_id, pose, orn=None):
        if orn is None:
            orn = p.getQuaternionFromEuler([0, 0, 0])
        p.resetBasePositionAndOrientation(obj_id, pose, orn)
