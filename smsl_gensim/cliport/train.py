...
def main(cfg):
    ...
    if 'multi' in dataset_type:
        ...
        train_path = cfg['train']['train_data_path'] or os.path.join(data_dir, '{}-train'.format(task))
        val_path = cfg['train']['val_data_path'] or os.path.join(data_dir, '{}-val'.format(task))
        train_ds = RavensDataset(train_path, cfg, n_demos=n_demos, augment=True)
        val_ds = RavensDataset(val_path, cfg, n_demos=n_val, augment=False)
